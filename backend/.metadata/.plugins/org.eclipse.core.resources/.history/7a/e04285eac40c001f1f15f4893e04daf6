...
public class TransferenciaService {
	...
	public BigDecimal calcularTaxa(LocalDate dataTransferencia, BigDecimal valorTransferencia) {
        ...
        long dias = ChronoUnit.DAYS.between(dataAtual, dataTransferencia);        
	...
	public TransferenciaDTO save(TransferenciaDTO dto) {
		...
		dto.setContaOrigem(contaOrigem.getNumero());
		dto.setContaDestino(contaDestino.getNumero());
	...
	private void copyDtoToEntity(TransferenciaDTO dto, Transferencia entity) {
	    ...
	    if (contaRepository == null) {
	        throw new IllegalStateException("ContaRepository não foi injetado corretamente.");
	    }
